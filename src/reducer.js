...
const reducer = (state = initialState, action) => {
	switch (action.type) {
		...
		case GET_RAICHU_COMPLETE: {
			// really update store if request succeeds
		...
		case GET_RAICHU_FAILED: {
			// remove what was optimistically updated to the store if request fails and save the error to the store instead
